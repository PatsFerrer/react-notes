    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className='rounded-md text-left flex flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
                ...
                < div className='absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-black/60 to-black/0 pointer-events-none' /> {/* essa div faz o sombreado do card e point events none faz com que a div nao atrapalhe na hora do mouse selecionar o texto*/}
            </Dialog.Trigger>

            {/* modal */}
            <Dialog.Portal>
                <Dialog.Overlay className='inset-0 fixed bg-black/50' /> {/* deixa o fundo escurinho */}
